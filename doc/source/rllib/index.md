...
:::{note}
To install on Apple Silicon computers, such as M1, [follow the installation instructions](https://docs.ray.io/en/latest/ray-overview/installation.html#m1-mac-apple-silicon-support).
:::
